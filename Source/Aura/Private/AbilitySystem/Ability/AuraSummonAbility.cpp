...
TArray<FVector> UAuraSummonAbility::GetSpawnLocations()
{
	...
	for (int32 i{ 0 }; i < NumMinions; ++i)
	{
		...
		DrawDebugSphere(GetWorld(), ChosenSpawnLocation, 18.f, 12.f, FColor::Blue, false, 3.f);
		...
		DrawDebugSphere(GetWorld(), Location + Direction * MinSpawnDistance, 5.f, 12.f, FColor::Red, false, 3.f);
		DrawDebugSphere(GetWorld(), Location + Direction * MaxSpawnDistance, 5.f, 12.f, FColor::Red, false, 3.f);
	}
